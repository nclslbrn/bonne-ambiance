...
const projectURL = "bonne-ambiance.local";
...
const zipName = "Bonne-Ambiance.zip";
...
// Package name.
const packageName = "Bonne-Ambiance";

// Where can users report bugs.
const bugReport = "https://github.com/nclslbrn/Bonne-Ambiance/issues";
