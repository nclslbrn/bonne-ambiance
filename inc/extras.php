...
add_filter('image_send_to_editor', 'ba_fluidbox_capable', 10, 7);
 ...
 */
function ba_fluidbox_capable($html, $id, $alt, $title, $align, $url, $size)
{
 ...
 */
function ba_mode_chooser_button()
{
	$switch  = '';
...
function ba_mode_chooser_menu()
{
	...
	$entry .= esc_html__('Light', 'Bonne-Ambiance');
	...
	$entry .= esc_html__('Dark', 'Bonne-Ambiance');
