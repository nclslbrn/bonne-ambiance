			...
			<article class="error-404 not-found">
				<header class="entry-header">
					<h1 class="entry-title">
						<?php echo esc_html__( 'error', 'Bonne-Ambiance' ); ?> 404
					</h1>
				</header><!-- .page-header -->
				...
				<div class="entry-content">
					...
					<p>
						<?php echo esc_html__( 'Oops! That page can&rsquo;t be found.', 'Bonne-Ambiance' ); ?>
					</p>
					<p>
						<?php echo esc_html__( 'Sorry, we couldn\'t find the page you were looking for!', 'Bonne-Ambiance' ); ?>
					</p>
				</div><!-- .page-content -->
			</article><!-- .error-404 -->
